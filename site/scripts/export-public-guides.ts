...
const fullTextGuideIds = new Set(mapCities.filter((city) => city.id.startsWith("taiwan-") || ["KR", "KP", "JP", "SG", "TH", "MY", "VN", "ID", "KH", "LA", "PH", "SI", "HR", "BG", "RO", "RS", "AE", "TR", "IN", "GB", "FR", "IT", "ES", "PT", "NL", "DE", "CZ", "AT", "HU", "GR"].includes(city.countryCode)).flatMap((city) => city.guideId ? [city.guideId] : []));
