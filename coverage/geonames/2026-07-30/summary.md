...
固定分母为 **16,049** 条，已处理 **894** 条，处理率 **5.570441%**。未列入决策账本的 **15,155** 条记录仍是未处理，不能计为完成。
...
|---|---:|---:|---:|---:|---:|---:|
| `cities15000` | 2,106 | 644 | 3 | 127 | 6 | 1,326 |
| `cities5000` | 773 | 1 | 0 | 0 | 0 | 772 |
| `cities1000` | 2,085 | 102 | 0 | 0 | 0 | 1,983 |
| `cities500` | 11,085 | 11 | 0 | 0 | 0 | 11,074 |
