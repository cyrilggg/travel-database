...
固定分母为 **16,049** 条，已处理 **900** 条，处理率 **5.607826%**。未列入决策账本的 **15,149** 条记录仍是未处理，不能计为完成。
...
|---|---:|---:|---:|---:|---:|---:|
| `cities15000` | 2,106 | 645 | 3 | 127 | 6 | 1,325 |
| `cities5000` | 773 | 2 | 0 | 0 | 0 | 771 |
| `cities1000` | 2,085 | 103 | 0 | 0 | 0 | 1,982 |
| `cities500` | 11,085 | 14 | 0 | 0 | 0 | 11,071 |
