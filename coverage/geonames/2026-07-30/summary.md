...
固定分母为 **16,049** 条，已处理 **922** 条，处理率 **5.744906%**。未列入决策账本的 **15,127** 条记录仍是未处理，不能计为完成。
...
|---|---:|---:|---:|---:|---:|---:|
| `cities15000` | 2,106 | 649 | 3 | 143 | 6 | 1,305 |
| `cities5000` | 773 | 3 | 0 | 0 | 0 | 770 |
| `cities1000` | 2,085 | 103 | 0 | 0 | 0 | 1,982 |
| `cities500` | 11,085 | 15 | 0 | 0 | 0 | 11,070 |
