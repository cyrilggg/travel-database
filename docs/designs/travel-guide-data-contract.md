...
编辑呈现采用[Lonely Planet 参照研究](../research/guide-presentation-lonely-planet.md)中本项目的选择：城市简介帮助读者认识城市，首访精选帮助选择，片区和核心地点导读解释体验，表格保留比较与查阅。简介按[旅行攻略写作技能](../../skills/travel-guide-writing/SKILL.md)控制篇幅，不承载时间分配、路线安排或仓库链接。新增导读先属于正文，不增加 frontmatter 字段，不改变 A/B/C 或对象身份；“体验”可能关联片区、地点和路线，不能一律作为坐标点。逐项卡片定位与精选模块须在具体功能中另定契约，当前 `body_section` 仍只关联主题区。
